...
country       <- 'ar_SubChpt_BestModel_woPandemic' #Country or region name. # <----- CHANGE HERE
...
prelog_data<-prelog_data[substr(prelog_data$age_group,1,2)=='ar',]
...
nrow(prelog_data)
nrow(prelog_data[n.obs2==max(n.obs2) & n.deaths2>450,])
prelog_data<-prelog_data[n.obs2==max(n.obs2) & n.deaths2>450,]
