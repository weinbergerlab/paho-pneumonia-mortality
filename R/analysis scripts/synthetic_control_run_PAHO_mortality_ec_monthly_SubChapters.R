...
country       <- 'ec_SubChpt_BestModel_woPandemic' #Country or region name.
...
prelog_data<-prelog_data[substr(prelog_data$age_group,1,2)=='ec',]
...
eval_period       <- as.Date(c('2011-08-01', '2015-12-01')) #Range over which rate ratio calculation will be performed.
