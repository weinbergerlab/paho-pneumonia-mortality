...
col1 <- read.csv("PAHO_QuarterTS_HDIcat_15Dec2018_SubChapters_Age.group2.csv", as.is = T)
...
setwd("~/Desktop/PAHO_Mortality_New/Data")
write.csv(all.agg, 'Quarterly_ByAgeGroup2_ByHDI_15Dec2018.csv', row.names=F)
