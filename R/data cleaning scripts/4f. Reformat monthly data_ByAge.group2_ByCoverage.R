...
col1 <- read.csv("PAHO_MonthlyTS_coverage_15Dec2018_SubChapters_Age.group2.csv", as.is = T)
...
setwd("~/Desktop/PAHO_Mortality_New/Data")
write.csv(all.agg, 'Monthly_ByAgeGroup2_ByCoverage_15Dec2018.csv', row.names=F)
