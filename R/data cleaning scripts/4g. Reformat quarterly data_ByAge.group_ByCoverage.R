...
# This script reformat time series data by coverage and Age.group
...
col1 <- read.csv("PAHO_QuarterTS_coverage_15Dec2018_SubChapters_Age.group.csv", as.is = T)
...
setwd("~/Desktop/PAHO_Mortality_New/Data")
write.csv(all.agg, 'Quarterly_ByAgeGroup1_ByCoverage_15Dec2018.csv', row.names=F)
